...
If you're interested in a re:load to call your own, they're [available as kits on Tindie](https://tindie.com/stores/arachnidlabs/reload-the-simple-robust-affordable-dummy-load/).
